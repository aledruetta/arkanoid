function App() {
    ...
    function Playground() {
        ...
        this.render = function() {
            ...
            if (this.width < 450) {
                this.height = $(window).height() - this.padding * 2;
            }
    ...
    function Block() {
        ...
        this.lines = 6;
        this.height = 20;
        this.width = playground.width / blocksPerLine - margin * 2;
    ...
    function Ball() {
        ...
        this.hitLeft   = function() {return this.x <= 0};
    ...
    function Touch() {
        ...
        function touchControls() {
            ...
            this.diameter = Math.floor((playground.width - this.margin * 6) / 3);
            this.diameter = (this.diameter <= 90) ? this.diameter : 90;
    ...
    function boundaryDetection() {
        ...
        if (ball.hitShip()) {
            var point = Math.abs((ship.width / 2) - ((ball.x + ball.diameter / 2) - ship.x));
            ball.directionY = -1;
            ball.speedX = point / 5 + 2;
        } else if (ball.hitBottom()) {
            reset();
            return;
        } else if (ball.hitRight() || ball.hitLeft()) {
            ball.directionX *= -1;
        } else if (ball.hitTop()) {
            ball.directionY = 1;
        }
